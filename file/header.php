			...
			<div class="logo_and_menu">
				<a href="../index.php"><div class="logo"></div></a>
					...
					<div class="topnav" id="myTopnav" style="z-index: 1">
					  ...
					  <div class="dropdown">
					    <a class="menu_text_a a_3"><img class="menu_text_icon" src="../images/icons/carayutyun1.png"><p class="menu_text"><?php foreach($db->menuTitle() as $key){if($key["id"] == 3)print $key["title_" . $_SESSION["NowLang"] . ""];} ?></p></a>
