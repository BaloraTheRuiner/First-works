<?php include "../header.php"; ?>
	...
	<div class="wrap_div">
		<div class="wrap_diamond operations_wrap_diamond">
			<div class="recons_diamond_icon wrap_diamond_icon oper_icon"></div>
		</div>
		<?php foreach ($db->operationsTitles() as $key){ if($key["id"] == 12){ ?>
			...
			<div class="operations_content">
				<div class="operations_content_div">
					...
					<div class="reconstructive">
						<img src="До-и-После.jpg">
						<img src="До-И-После1.jpg">
					</div>
				</div>
