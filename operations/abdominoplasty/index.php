<?php include "../header.php"; ?>
	...
	<div class="wrap_div">
		<div class="wrap_diamond operations_wrap_diamond">
			<div class="abdominoplasty_diamond_icon wrap_diamond_icon oper_icon"></div>
		</div>
		<?php foreach ($db->operationsTitles() as $key){ if($key["id"] == 4){ ?>
		<div id="abdominoplasty_id" class="wrap_line"><b><?=$key["title_" . $_SESSION["NowLang"] . ""]?></b></div>
	</div>
				  ...
				  <div id="myCarousel" class="carousel slide" data-ride="carousel">
				    ...
				    <div class="carousel-inner">
				      ...
				      <div class="item active">
				        <div class="slider_img" style="background-image: url('../../images/operations/До-и-После110.jpg');background-size: auto 100%;"></div>
				        <div class="carousel-caption"></div>
				      </div>

					<?php foreach ($db->operationsSlider() as $key){ if ($key["operations_id"] == 4){ ?>
